					...
					<div class="col-lg-7 mx-auto text-white">
						<div class="row align-items-center d-flex flex-row">
							...
							<div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
								<h2>Desculpe!</h2>
								<h1 class="font-weight-light">Mensagem de erro, entre em
									contato com o suporte do sistema.</h1>
								<% out.println(request.getAttribute("msg"));%>
							</div>
						</div>
						<div class="row mt-5">
							<div class="col-12 text-center mt-xl-2">
								<a class="text-white font-weight-medium" href="index.jsp">Retornar
									para o Inicio.</a>
							</div>
						</div>
						<div
							...
							<span
								...
								© cristiano santos 2024</span> <span
